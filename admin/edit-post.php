            ...
            <form class="client_form" action="functions/new_post.php" method="post" enctype="multipart/form-data">
                <input type="hidden" value="<?=$row['id'];?>" name="id">
                   <div class="form-group col-md-12">
                         <label for="">Title</label> <input class="form-control " required type="text" name="title" placeholder="Please enter the name" value="<?=$row["title"];?>">
                    </div>

                         <div class="col-md-6">
                            <div class="form-group">
                                <label for=""> Date</label>
                                <input class="form-control" required type="date" name="date" value="<?=$row["date"];?>">
                            </div>
                        </div>
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" required type="text" name="author" value="<?=$row["author"];?>">
                            </div>
                        </div>
                         ...
                         <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <?php if($row['image']) {?>
                                <img src="uploads//blog/<?=$row['image'];?>" width="100px" height="100px">
                 ...
                 <br>
                        ...
                        <div class="col-md-12">
                             <div class="form-group in-div" style="width: 100%;">
                                ...
                                <textarea name="content" class="form-control" id="editor" style="width: 100%;"><?=($row["content"]);?></textarea>
                            </div>
                        </div>
