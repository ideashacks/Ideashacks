                                    ...
                                    <div class="inbox-center">
                                            <?php  
                                                            if (isset($_GET['posted'])) {
                                                                ...
                                                                echo'<div class="alert alert-success" >
                                                                   <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                                   <strong>DONE!! </strong><p> Your  post has been successfully updated.</p>
                                                                   </div>';
                                                            }    
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                             <?php
                                              ...
                                              '<tr>
                                                    <td class="">'.$row["id"].'</td>
                                                    <td class="h"><a href="post-details.php?id='.$row["id"].'" />'.$row["title"].'</td>
                                                    <td class="tet">'.$row["date"].'</td>
                                                    <td class=""> <a href="edit-post.php?id='.$row["id"].'" class="btn btn-info  btn-outline p-1" />Edit</td>
                                                    <td class="">   <a href="#" class="btn btn-danger btn-rounded btn-outline p-1 " data-toggle="modal" data-target="#responsive-modal'.$row["id"].'">Delete </a></td>
                                                    </td>
                                                </tr>
                                                    <!-- /.modal -->
